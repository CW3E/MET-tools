...
export USR_HME=/home/jlconti/git_clone/MET-tools

# Root directory of simulation IO
export SIM_ROOT=/expanse/nfs/cw3e/cwp157/NRT_2023_2024

# Root directory of simulation verification IO
export VRF_ROOT=/expanse/nfs/cw3e/cwp157/jlconti/VERIFICATION_IO
